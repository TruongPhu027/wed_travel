! function() {
                        ...
                        let e = {
                            ...
                            equalizeItems: function(t) {
                                ...
                                e.maxHeight = 0, e.rowEnd = e.disablePerRow ? e.boxCount : e.colPerRow, e.$items = [], e.rating = {
                                    ...
                                    var n;
                                    i.length && (e.rating.present = !0, e.rating.height = i.height(), e.rating.dummy = null !== (n = e.rating.dummy) && void 0 !== n ? n : '<div class="js-star-rating ' + i.attr("class") + '" style="opacity: 0; visibility: hidden"></div>'), o.children(".js-ux-swatches").remove();
                ...
                Flatsome.plugin("addQty", (function(t, e) {
                    ...
                    String.prototype.uxGetDecimals || (String.prototype.uxGetDecimals = function() {
                        ...
                        let o = parseFloat(e.val()),
                            ...
                            r = e.attr("step");
                        o && "" !== o && "NaN" !== o || (o = 0), "" !== i && "NaN" !== i || (i = ""), "" !== n && "NaN" !== n || (n = 0), "any" !== r && "" !== r && void 0 !== r && "NaN" !== parseFloat(r) || (r = 1), t.is(".plus") ? i && (i === o || o > i) ? e.val(i) : e.val((o + parseFloat(r)).toFixed(r.uxGetDecimals())) : n && (n === o || o < n) ? e.val(n) : o > 0 && e.val((o - parseFloat(r)).toFixed(r.uxGetDecimals())), e.trigger("input"), e.trigger("change")
                    }))
                }))
            },
            775: function() {
                            ...
                            c.prototype._init = function() {
                                ...
                                if (flatsomeVars.rtl && (d = e - d), d < 0 || h < 0 || d > e || h > o) this.hide();
                                    ...
                                    "transform" in document.body.style ? this.$zoom.css({
                                        transform: `translate(${flatsomeVars.rtl?-f:f}px, ${m}px)`
                                    }) : this.$zoom.css({
                                        top: m,
                                        left: f
    ...
    a.m = n, e = Object.getPrototypeOf ? function(t) {
        ...
        }, o = {}, i = "flatsome:", a.l = function(t, e, n, r) {
            if (o[t]) o[t].push(e);
            else {
                var s, c;
                if (void 0 !== n)
                ...
                var h = function(e, i) {
                        ...
                        var n = o[t];
                        if (delete o[t], s.parentNode && s.parentNode.removeChild(s), n && n.forEach((function(t) {
                                return t(i)
                            })), e) return e(i)
                    },
        ...
        function() {
            ...
            o(), t.addEventListener ? .("change", o), jQuery.loadMagnificPopup = i, jQuery.fn.lazyMagnificPopup = function(t) {
                ...
                return o.one("click", (n => {
                    n.preventDefault(), i().then((() => {
                                ...
                                jQuery.post(flatsomeVars.ajaxurl, n, (function(t) {
                                    i().then((() => {
                                        ...
                                        let l = function() {
                                            ...
                                            u = function() {
                                                n.data("flickity") && n.imagesLoaded((function() {
                                                    n.flickity("resize")
                                                }))
                                            };
                                        jQuery.when(c).done((() => {
                                            ...
                                            jQuery.when(c).done((() => {
                                                e.image.src ? (r.attr("src", e.image.src).attr("srcset", ""), a.attr("href", e.image_link), l(), u()) : e.image_src && (r.attr("src", e.image_src).attr("srcset", ""), a.attr("href", e.image_link), l(), u())
                                            }))
                ...
                t(".ux-buy-now-button").each((function() {
                    ...
                    o.length && function(t) {
                        if ("MutationObserver" in window) return new MutationObserver((function(e) {
                ...
                "undefined" != typeof wc_add_to_cart_variation_params && e.hasClass("disabled") && (t.preventDefault(), e.hasClass("wc-variation-is-unavailable") ? alert(wc_add_to_cart_variation_params.i18n_unavailable_text) : e.hasClass("wc-variation-selection-needed") && alert(wc_add_to_cart_variation_params.i18n_make_a_selection_text))
            })), a(775), jQuery((function(t) {
                const e = {
                    openDrawer: null,
                    openDropdown: null
                };
                ...
                function o() {
                    !t(".cart-item .nav-dropdown").length || window.matchMedia("(max-width: 849px)").matches && t(".header-main .cart-item .header-cart-link.off-canvas-toggle").length ? function() {
                        let o = 0;
                        ...
                        e.openDrawer && clearTimeout(e.openDrawer), e.openDrawer = setTimeout((() => {
                            t(".cart-item .off-canvas-toggle").trigger("click")
                        }), o)
                    }() : (t(".cart-item.has-dropdown").addClass("current-dropdown cart-active"), e.openDropdown && clearTimeout(e.openDropdown), e.openDropdown = setTimeout((() => {
                ...
                function i() {
                    ...
                    })(window.flatsomeVars.is_mini_cart_reveal) && t("body").on("added_to_cart", i), t(document).on("flatsome-open-mini-cart", o), t(".shop-container").on("click", (() => e.removeClass("current-dropdown cart-active"))), e.hover((() => t(".cart-active").removeClass("cart-active")))
                }()
            })), a(8417), a(4696);
            var n = !1;
            ...
            jQuery(document).on("flatsome-product-gallery-tools-init", (() => {
                r || (n = jQuery(".has-image-zoom .slide").easyZoom({
                    loadingNotice: "",
                    preventClicks: !1
                ...
                const m = t.when(c, l).then((() => {
                    r && h(), o.on("hide_variation", (function(o, i) {
                ...
                const o = function(t, e = {}) {
                    ...
                    const {
                        top: i
                    } = o.boundingClientRect, n = o.intersectionRatio <= 0 && i <= 0;
                ...
                t(`#product-${i} button.single_add_to_cart_button:visible`).first().each(((i, r) => {
                    const a = t(r).closest("form.cart");
                    n(t(".qty", e), t(".qty", a)), n(t(".qty", a), t(".qty", e)), o.observe(r)
                }))
            })), a(1330), jQuery("table.my_account_orders").wrap('<div class="touch-scroll-table"/>'), jQuery(document.body).on("submit", "form.cart", (function(t) {
                if (void 0 === t.originalEvent) return;
                const e = jQuery(t.originalEvent.submitter);
                e.is(".single_add_to_cart_button, .ux-buy-now-button") && (e.hasClass("disabled") || e.addClass("loading"), jQuery(window).on("pageshow", (() => {
